...
- [x] Step 139: [Search forward and backward](https://viewsourcecode.org/snaptoken/kilo/06.search.html#search-forward-and-backward) - code in `editor_find_callback` to set `direction` variable using arrow keys
- [x] Step 140: Search forward and backward - modify search algorithm to use `direction` variable
- [x] Step 141: Search forward and backward - update prompt string
